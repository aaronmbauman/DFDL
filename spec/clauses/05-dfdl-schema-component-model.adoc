...
The XSD minOccurs and XSD maxOccurs values are interpreted in conjunction with the DFDL dfdl:occursCountKind property. See <<properties-for-array-elements-and-optional-elements>>, Properties for Array Elements and Optional Elements, for more details.
