...
* Common to both Content and Framing (see <<properties-common-to-both-content-and-framing>>)
...
* Array elements and optional elements (see <<properties-for-array-elements-and-optional-elements>>)
