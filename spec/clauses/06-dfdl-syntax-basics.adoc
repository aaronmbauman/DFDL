...
| dfdl:assert
| Defines a test to be used to ensure the data are well formed. Assert is used only when parsing data. See Section 7.5
...
Properties carried on the component format annotations (See Section 7.1) are called _format properties_. A format property that is used to describe a physical characteristic of a component is called a _representation_ property.
