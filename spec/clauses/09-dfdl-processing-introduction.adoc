...
. When there are dfdl:assertfootnote:[DFDL asserts are described in Section 7.5 The dfdl:assert Statement Annotation Element.] statements with failureType 'processingError' on the component, all their expressions evaluate to true or their regular expression patterns match.
