...
Occurrences with empty representation may or may not be added to the Infoset, as described in Section <<element-defaults>>. If a required occurrence is not added to the Infoset, it may be a Processing Error, dependent on dfdl:occursCountKind as described in Section <<the-dfdl-occurscountkind-property>>.

Occurrences with absent representation are not added to the Infoset. For a required occurrence it may be a Processing Error, dependent on dfdl:occursCountKind as described in Section <<the-dfdl-occurscountkind-property>>.
